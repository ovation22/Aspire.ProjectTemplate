...
/// <summary>
/// Represents a paginated specification for querying entities with result transformation.
/// </summary>
/// <typeparam name="T">The type of entity to query.</typeparam>
/// <typeparam name="TResult">The type of result after transformation.</typeparam>
/// <remarks>
/// Initializes a new instance of the <see cref="PaginatedSpecification{T, TResult}"/> class.
/// </remarks>
/// <param name="pageNumber">The page number.</param>
/// <param name="pageSize">The page size.</param>
public abstract class PaginatedSpecification<T, TResult>(int pageNumber, int pageSize) : Specification<T, TResult>, IPaginatedSpecification<T, TResult>
{
    /// <inheritdoc />
